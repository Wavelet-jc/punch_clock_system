...
function parseKQ(html) {
    ...
    while (true) {
        ...
        let m = rex.exec(html)
        let n5 = _dataStackOfDateTime.pop() || undefined
        if (m) {
            ...
            if (n5) {
                console.log('n:'+n5);
                let time2 = moment(n5[4], 'M/D/YYYY H:mm:ss')
...
// }
function askAll() {
    inquire('2020-12-24', '2021-1-6', 'ANNE', false, ).then(function(){
      return inquire('2020-12-24', '2021-1-11', 'john', false, )
    }).then(
        function () {
            inquire('2020-12-28', '2021-1-11', 'S2008001', false, )
        }
